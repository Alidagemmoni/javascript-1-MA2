...
//4. Given the following paragraph, create a JavaScript function that changes all mentions of strawberry to banana and strawberries to bananas: 
 function changingFruits () {
     var firstString = document.getElementById("firstString").innerHTML;
     var newString = firstString.replace("strawberries", "bananas").replace("strawberry", "banana");
                document.getElementById("firstString").innerHTML = newString;
 }
